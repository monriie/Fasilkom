const AkademikCard = ({img,tanggal,judul}) => {
  return (
    <article className="flex md:flex-col lg:flex-col w-auto md:w-65 lg:w-[512px] cursor-pointer">
        <img src={img} className="w-40 h-auto rounded-xl md:w-60 md:h-40 lg:w-[512px] lg:h-[325px]"/>
        <div className="flex flex-col w-40 ml-2 md:w-60 lg:w-[512px]">
            ...
            <h3 className="text-black text-sm text-left md:text-xl lg:text-[32px]">{judul}</h3>
